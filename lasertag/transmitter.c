...
#define TX_INIT_ST_MSG "sc_init_st\n"
#define TX_CHECK_TRIGGER_ST_MSG "tx_checkTrigger_st\n"
#define TX_TRANSMIT_ST_MSG "tx_transmit_st\n"
#define TX_RELEASED_ST_MSG "tx_released_st\n"
...
static uint16_t frequencies = {1471, 1724, 2000, 2273, 2632,
                               2941, 3333, 3571, 3846, 4167};
...
void txDebugStatePrint() {
  ...
  void transmitter_init() {
    ...
    mio_init(false); // false disables any debug printing if there is a system
                     // failure during init.
    mio_setPinAsOutput(
        TRANSMITTER_OUTPUT_PIN); // Configure the signal direction of the pin to
                                 // be an output.
  }
